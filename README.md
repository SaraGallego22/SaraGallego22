...
<p align="center">
  <a href="https://www.linkedin.com/in/sara-gallego-villada/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"></a>
  <a href="mailto:saragallegovillada@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email"></a>
  <a href="https://github.com/SaraGallego22"><img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"></a>
</p>
...
![Bedrock](https://img.shields.io/badge/Bedrock-232F3E?style=flat-square&logo=amazonwebservices&logoColor=white)
...
- **GenAI & NLP:** AI agents (Google ADK, Bedrock Agents), RAG, vector DBs (FAISS / Chroma), hybrid search (BM25 + bi-encoder + cross-encoder), prompt engineering, Text-to-SQL
- **Computer Vision:** object detection (YOLO), OCR pipelines, image segmentation, Document AI
- **Core ML & Math:** time-series forecasting, optimization, evolutionary algorithms (NSGA-II), numerical methods
...
|---|---|---|
| **2026 – Present** | **Knowledge Data Engineer** · Davivienda | AI-agent governance on Vertex AI (GitHub Actions + Gemini semantic evaluation before release); automated testing pipeline for a credit-decision engine with Google ADK + Cloud Run; hybrid-search knowledge-base reconciliation; DAX → BigQuery SQL translation with Gemini. |
| **2025 – 2026** | **Data Builder** · Flypass | Conversational GenAI agent on **Amazon Bedrock** for natural-language querying of logistics data; serverless analytics platform (API Gateway → Lambda → Glue). |
| **2024** | **Jr. Machine Learning Engineer** · Bonnet Analytics | Text-to-SQL system on BigQuery; CV pipeline for invoice / manifest extraction; ETL architectures on GCP and Azure for healthcare and industrial clients; RAG assistants with LangChain. |
...
- **Serverless Agentic Workflows with Amazon Bedrock** — DeepLearning.AI / AWS (2026)
- **LLMOps: Building Real-World Applications with LLMs** — DeepLearning.AI × Google Cloud (2025)
